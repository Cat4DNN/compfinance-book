...
| **Algebraic Effects** | Type-safe effects, continuations, formal reasoning | 1 paper |
| **Category Theory** | Bigraphs, Trigraphs, monoidal categories | 1 paper |
...
- **Neural Differential Equations for Option Pricing** — Combining SDEs with deep learning
- **Categorical Semantics for Transformers** — Functorial interpretation of attention mechanisms
- **Effect Systems for Risk Management** — Type-level guarantees for financial compliance
